...
class AbstractBackgroundPlugin(CMSPlugin):
    ...
    circle_position = models.CharField(max_length=30, choices=POSITION_CHOICES, blank=True)
    ...
    def add_background_variables(self, context):
        ...
        context['has_bg_circle'] = '-has-bg-circle' if self.color or self.size or self.circle_position else False