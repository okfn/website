...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PressMention.published'
        db.add_column(u'press_pressmention', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PressMention.published'
        db.delete_column(u'press_pressmention', 'published')
