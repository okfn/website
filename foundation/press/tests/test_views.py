...
class PressReleaseViewTest(WebTest):
    ...
    def test_old_releases_in_response(self):
        ...
        one_month_old_url = reverse(
            "press-release", kwargs={"slug": self.one_month_old.slug}
        )
        ...
        one_day_old_url = reverse(
            "press-release", kwargs={"slug": self.one_day_old.slug}
        )
...
class PressMentionViewTest(WebTest):
    ...
    def test_press_mention_in_response(self):
        ...
        mention_url = reverse("press-mention", kwargs={"slug": self.mention.slug})
        self.assertTrue(mention_url in response)

    # def test_press_releases_in_response(self):
    #     response = self.app.get(reverse("press-mentions"))
    #     releases_url = reverse("press-releases")
        # TODO test skipped until we define if "press-releases" URL must be
        # included in the press mentions page
    ...
    def test_unpublished_mention_not_in_response(self):
        ...
        mention_url = reverse(
            "press-mention", kwargs={"slug": self.unpublished_mention.slug}
        )
