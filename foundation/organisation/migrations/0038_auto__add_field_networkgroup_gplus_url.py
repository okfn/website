...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NetworkGroup.gplus_url'
        db.add_column(u'organisation_networkgroup', 'gplus_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NetworkGroup.gplus_url'
        db.delete_column(u'organisation_networkgroup', 'gplus_url')
