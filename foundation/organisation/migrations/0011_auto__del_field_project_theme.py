...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'organisation_project', 'theme_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Project.theme'
        raise RuntimeError("Cannot reverse this migration. 'Project.theme' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Project.theme'
        db.add_column(u'organisation_project', 'theme',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['organisation.Theme']),
                      keep_default=False)
    ...
    models = {
        ...
        u'organisation.project': {
            ...
            'themes': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['organisation.Theme']", 'symmetrical': 'False'}),
            'twitter': ('django.db.models.fields.CharField', [], {'max_length': '18', 'blank': 'True'}),
            'types': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['organisation.ProjectType']", 'symmetrical': 'False'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
