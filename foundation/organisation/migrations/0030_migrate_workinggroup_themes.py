...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Migrate foreign key to many to many field
        for workinggroup in orm.WorkingGroup.objects.all():
            workinggroup.themes.add(workinggroup.theme)
            workinggroup.save()

    def backwards(self, orm):
        # Just pick the first theme in the many to many field and use that
        for workinggroup in orm.WorkingGroup.objects.all():
            workinggroup.theme = workinggroup.themes.first()
            workinggroup.save()
