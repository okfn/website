...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NetworkGroupMembership.order'
        db.add_column(u'organisation_networkgroupmembership', 'order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NetworkGroupMembership.order'
        db.delete_column(u'organisation_networkgroupmembership', 'order')
