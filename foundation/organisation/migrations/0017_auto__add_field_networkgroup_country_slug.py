...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NetworkGroup.country_slug'
        db.add_column(u'organisation_networkgroup', 'country_slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NetworkGroup.country_slug'
        db.delete_column(u'organisation_networkgroup', 'country_slug')
