...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NetworkGroup.youtube'
        db.add_column(u'organisation_networkgroup', 'youtube',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NetworkGroup.youtube'
        db.delete_column(u'organisation_networkgroup', 'youtube')
