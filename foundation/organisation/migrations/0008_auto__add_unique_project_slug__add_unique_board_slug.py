...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'organisation_project', ['slug'])

        # Adding unique constraint on 'Board', fields ['slug']
        db.create_unique(u'organisation_board', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Board', fields ['slug']
        db.delete_unique(u'organisation_board', ['slug'])

        # Removing unique constraint on 'Project', fields ['slug']
        db.delete_unique(u'organisation_project', ['slug'])
