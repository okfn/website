...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeaturedTheme'
        db.create_table(u'organisation_featuredtheme', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['organisation.Theme'])),
        ))
        db.send_create_signal(u'organisation', ['FeaturedTheme'])

        # Adding field 'Theme.picture'
        db.add_column(u'organisation_theme', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FeaturedTheme'
        db.delete_table(u'organisation_featuredtheme')

        # Deleting field 'Theme.picture'
        db.delete_column(u'organisation_theme', 'picture')
