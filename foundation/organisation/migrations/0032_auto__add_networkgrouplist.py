...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NetworkGroupList'
        db.create_table(u'organisation_networkgrouplist', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('group_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'organisation', ['NetworkGroupList'])


    def backwards(self, orm):
        # Deleting model 'NetworkGroupList'
        db.delete_table(u'organisation_networkgrouplist')
