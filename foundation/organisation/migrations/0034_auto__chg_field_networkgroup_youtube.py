...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'organisation_networkgroup', 'youtube', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'NetworkGroup.youtube'
        db.alter_column(u'organisation_networkgroup', 'youtube', self.gf('django.db.models.fields.CharField')(max_length=18))
