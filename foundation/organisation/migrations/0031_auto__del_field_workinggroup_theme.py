...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkingGroup.theme'
        db.delete_column(u'organisation_workinggroup', 'theme_id')


    def backwards(self, orm):
        # Adding field 'WorkingGroup.theme'
        db.add_column(u'organisation_workinggroup', 'theme',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisation.Theme'], null=True, blank=True),
                      keep_default=False)
