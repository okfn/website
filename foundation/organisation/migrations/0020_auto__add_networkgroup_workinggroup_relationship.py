...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field working_groups on 'NetworkGroup'
        m2m_table_name = db.shorten_name(u'organisation_networkgroup_working_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('networkgroup', models.ForeignKey(orm[u'organisation.networkgroup'], null=False)),
            ('workinggroup', models.ForeignKey(orm[u'organisation.workinggroup'], null=False))
        ))
        db.create_unique(m2m_table_name, ['networkgroup_id', 'workinggroup_id'])


    def backwards(self, orm):
        # Removing M2M table for field working_groups on 'NetworkGroup'
        db.delete_table(db.shorten_name(u'organisation_networkgroup_working_groups'))
