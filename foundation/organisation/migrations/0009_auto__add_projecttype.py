...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'organisation_projecttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'organisation', ['ProjectType'])

        # Adding M2M table for field themes on 'Project'
        m2m_table_name = db.shorten_name(u'organisation_project_themes')
        ...
        db.create_unique(m2m_table_name, ['project_id', 'theme_id'])

        # Adding M2M table for field types on 'Project'
        m2m_table_name = db.shorten_name(u'organisation_project_types')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'organisation.project'], null=False)),
            ('projecttype', models.ForeignKey(orm[u'organisation.projecttype'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'organisation_projecttype')

        # Removing M2M table for field themes on 'Project'
        db.delete_table(db.shorten_name(u'organisation_project_themes'))

        # Removing M2M table for field types on 'Project'
        db.delete_table(db.shorten_name(u'organisation_project_types'))
