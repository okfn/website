...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkingGroup.theme'
        db.alter_column(u'organisation_workinggroup', 'theme_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisation.Theme'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WorkingGroup.theme'
        raise RuntimeError("Cannot reverse this migration. 'WorkingGroup.theme' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WorkingGroup.theme'
        db.alter_column(u'organisation_workinggroup', 'theme_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisation.Theme']))
