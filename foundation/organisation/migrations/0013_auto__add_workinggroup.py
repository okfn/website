...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'organisation_workinggroup', (
            ...
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisation.Theme'], blank=True)),
            ('incubation', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'organisation', ['WorkingGroup'])


    def backwards(self, orm):
        # Deleting model 'WorkingGroup'
        db.delete_table(u'organisation_workinggroup')
    ...
    models = {
        ...
        u'organisation.workinggroup': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '100'}),
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['organisation.Theme']", 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'})
        }
    }
