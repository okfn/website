...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field themes on 'WorkingGroup'
        m2m_table_name = db.shorten_name(u'organisation_workinggroup_themes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workinggroup', models.ForeignKey(orm[u'organisation.workinggroup'], null=False)),
            ('theme', models.ForeignKey(orm[u'organisation.theme'], null=False))
        ))
        db.create_unique(m2m_table_name, ['workinggroup_id', 'theme_id'])


    def backwards(self, orm):
        # Removing M2M table for field themes on 'WorkingGroup'
        db.delete_table(db.shorten_name(u'organisation_workinggroup_themes'))
