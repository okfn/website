...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageBannerExtension'
        db.create_table(u'djangocms_pagebanner_pagebannerextension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['djangocms_pagebanner.PageBannerExtension'])),
        ...
        db.send_create_signal(u'djangocms_pagebanner', ['PageBannerExtension'])


    def backwards(self, orm):
        # Deleting model 'PageBannerExtension'
        db.delete_table(u'djangocms_pagebanner_pagebannerextension')
